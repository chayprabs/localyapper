...
const HOTKEY_DEFINITIONS: {
...
}[] = [
  {
    key: "hotkey_record",
    label: "Record",
    description: "Hold to dictate. Double-tap to toggle hands-free.",
    defaultValue: "F8",
    readOnly: false,
  },
  {
    key: "hotkey_cancel",
    label: "Cancel",
    description: "Stop without injecting (active while recording)",
    defaultValue: "Escape",
    readOnly: false,
  },
  {
    ...
    label: "Paste Last",
    description: "Re-inject the last dictation",
  ...
  },
  {
    key: "hotkey_open_app",
    label: "Open App",
    description: "Show the LocalYapper window",
